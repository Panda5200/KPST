    ...
    <div class="container" style="margin-top:20px">
        ...
        if(isset($_POST['submit'])){
            ...
            if(mysqli_num_rows($cek) == 0){
                $sql = mysqli_query($koneksi, "INSERT INTO apps(namaapps, alamat, unitkerja, departemen) VALUES('$namaapps', '$alamat', '$unitkerja', '$departemen')") or die(mysqli_error($koneksi));
                ...
                echo '<div class="alert alert-warning"> Aplikasi sudah terdaftar.</div>';
            }
        }
        ?>
        ...
        <form action="create.php" method="post">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="namaapps" class="form-control" size="4" required>
                </div>
            </div>
            <div class="form-group row">
